...
export const HabitCard: React.FC<HabitCardProps> = React.memo(
  ({ habit, records, streak, onToggle, onDelete }) => {
    ...
    const allEditableDates: string[] = getDateRangeArray(habitStart, editableEnd);
    ...
    const visibleWeek: string[] = weeks[currentWeekIndex] || [];
    ...
    const getRecordForDate = (date: string): HabitRecord | undefined => {
